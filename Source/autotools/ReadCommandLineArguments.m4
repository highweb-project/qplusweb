...
AC_MSG_CHECKING([Support Odroid])
AC_ARG_ENABLE([odroid], 
    AS_HELP_STRING([--enable-odroid],[Enable Odroid (default: disabled)]),
    [],
    [enable_odroid=no])
AC_MSG_RESULT([$enable_odroid])

AC_MSG_CHECKING([Support webcl])
AC_ARG_ENABLE([webcl], 
    AS_HELP_STRING([--enable-webcl],[Enable support for webcl [default:no]]),
    [],
    [enable_webcl=no])
AC_MSG_RESULT([$enable_webcl])

AC_MSG_CHECKING([webcl confmrnace test support])
AC_ARG_ENABLE([webcl_conformance_test], 
    AS_HELP_STRING([--enable-webcl-conformance-test],[Enable support for webcl conformance test [default:no]]),
    [],
    [enable_webcl_conformance_test=no])
AC_MSG_RESULT([$enable_webcl_conformance_test])

AC_MSG_CHECKING([Support enable webengine])
AC_ARG_ENABLE(engine,
	AC_HELP_STRING([--enable-engine],[Modify Engine (default:no)]),
	[],
	[enable_engine=no])
