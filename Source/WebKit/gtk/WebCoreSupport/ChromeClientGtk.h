...
namespace WebKit {
...
#if MODIFY(ENGINE)
        virtual void elementDidFocus(Node*);
#endif
    ...
    virtual PassOwnPtr<ColorChooser> createColorChooser(ColorChooserClient* client, const Color& color);
    virtual void removeColorChooser();
    virtual void updateColorChooser(const Color&);
#endif

#if ENABLE(DATE_AND_TIME_INPUT_TYPES)
    virtual PassRefPtr<DateTimeChooser> openDateTimeChooser(DateTimeChooserClient* client, const DateTimeChooserParameters& parameter);
    virtual void removeDateTimeChooser();
    virtual void updateDateTimeChooser(const String& value);
    ...
    virtual void enableWebGL();
    virtual void enableWebCL();
    
    private:
#if MODIFY(ENGINE)
        ColorChooserClient* m_chooserClient;
        DateTimeChooserClient* m_datetimechooserClient;
#endif
