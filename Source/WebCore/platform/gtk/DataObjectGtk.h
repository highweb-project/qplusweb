...
#if MODIFY(ENGINE)
#if ENABLE(DATA_TRANSFER_ITEMS)
    static PassRefPtr<DataObjectGtk> create(PassRefPtr<Clipboard> clipboard, ScriptExecutionContext* context)
    {
        return adoptRef(new DataObjectGtk(DataTransferItemListGtk::create(clipboard, context)));
    }
    DataObjectGtk(PassRefPtr<DataTransferItemListGtk>);
    DataObjectGtk() { }
#endif
#endif
...
#if MODIFY(ENGINE)
#if ENABLE(DATA_TRANSFER_ITEMS)
    PassRefPtr<DataTransferItemListGtk> itemList() { return m_itemList; }
#endif
#endif
...
#if MODIFY(ENGINE)
#if ENABLE(DATA_TRANSFER_ITEMS)
    RefPtr<DataTransferItemListGtk> m_itemList;
#endif
#endif
};
