...
struct _WebKitWebViewClass {
    ...
    void                        (* enable_webgl)(WebKitWebView* web_view);
    void                        (* enable_webcl)(WebKitWebView* web_view);
};
...
#if defined(MODIFY_ENGINE)
typedef enum
{
    WEBKIT_LAUNCHER_MODE_BROWSER,
    WEBKIT_LAUNCHER_MODE_APP
} WebKitLauncherMode;


WEBKIT_API void
webkit_web_view_hide_scrollbar					(WebKitWebView        *web_view);
WEBKIT_API void
webkit_web_view_set_app_mode              (WebKitWebView        *web_veiw, WebKitLauncherMode mode);
WEBKIT_API WebKitLauncherMode
webkit_web_view_app_mode               (WebKitWebView        *web_view);

// WEBKIT_API void
// webkit_web_view_enable_webgl          (WebKitWebView*     web_view);
// WEBKIT_API void
// webkit_web_view_enable_webcl          (WebKitWebView*     web_view);
