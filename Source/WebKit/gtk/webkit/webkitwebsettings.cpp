...
static void webkit_web_settings_class_init(WebKitWebSettingsClass* klass)
{
    ...
    */
    ...
    /**
    * WebKitWebSettings:enable-webcl:
    *
    * Enable or disable support for WebCL on pages. WebCL is an experimental
    * proposal for allowing web pages to use OpenCL 1.1-like calls directly. The
    * standard is currently a work-in-progress by the Khronos Group.
    *
    * Since: 2.3.4
    */
    g_object_class_install_property(gobject_class,
                                    PROP_ENABLE_WEBCL,
                                    g_param_spec_boolean("enable-webcl",
                                                         _("Enable WebCL"),
                                                         _("Whether WebCL content should be rendered"),
                                                         FALSE,
                                                         flags));
...
static void webkit_web_settings_set_property(GObject* object, guint prop_id, const GValue* value, GParamSpec* pspec)
{
    ...
    case PROP_ENABLE_WEBGL:
        ...
        break;
    case PROP_ENABLE_WEBCL:
        priv->enableWebcl = g_value_get_boolean(value);
        break;
...
static void webkit_web_settings_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    ...
    case PROP_ENABLE_WEBGL:
        ...
        break;
    case PROP_ENABLE_WEBCL:
        g_value_set_boolean(value, priv->enableWebcl);
        break;
    case PROP_ENABLE_MEDIA_STREAM:
